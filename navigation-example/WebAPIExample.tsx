...
import { GaodeWebAPI, DrivingStrategy, TransitStrategy } from 'expo-gaode-map-web-api';

/**
 * 高德地图 Web API 示例
 * 包含：地理编码、逆地理编码、路径规划等功能
 */
...
🏢 地址组成：
国家：${info.addressComponent.country}
省份：${info.addressComponent.province}
城市：${info.addressComponent.city || '直辖市'}
区县：${info.addressComponent.district}
街道：${info.addressComponent.township}
街道名：${info.addressComponent.street}
门牌号：${info.addressComponent.number}
