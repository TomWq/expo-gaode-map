...
- `NaviView` 官方嵌入式导航
- `EmbeddedNaviView` 自绘嵌入式 HUD / 车道 HUD
- 独立算路与路线选择
- Web 路线预览与近似跟线导航
- 官方黑盒导航页调起
...
- `UI Props 调试页`
  用于验证 `EmbeddedNaviView` 顶部 HUD、车道 HUD、路口大图、3D 路口模型等 UI 开关
- `独立算路导航`
  展示“先算路、后选择、再导航”的流程
- `跟随 Web 路线`
